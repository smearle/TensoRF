...
_LOCROTMSG = _descriptor.Descriptor(
  name='LocRotMsg',
  full_name='dk.itu.real.ooe.LocRotMsg',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='location', full_name='dk.itu.real.ooe.LocRotMsg.location', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rotation', full_name='dk.itu.real.ooe.LocRotMsg.rotation', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOCROTMSG.fields_by_name['location'].message_type = _POINT
_LOCROTMSG.fields_by_name['rotation'].message_type = _POINT
...
DESCRIPTOR.message_types_by_name['LocRotMsg'] = _LOCROTMSG
...
LocRotMsg = _reflection.GeneratedProtocolMessageType('LocRotMsg', (_message.Message,), dict(
  DESCRIPTOR = _LOCROTMSG,
  __module__ = 'src.main.proto.minecraft_pb2'
  # @@protoc_insertion_point(class_scope:dk.itu.real.ooe.LocRotMsg)
  ))
_sym_db.RegisterMessage(LocRotMsg)
...
_MINECRAFTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='setPlayerLocRot',
    full_name='dk.itu.real.ooe.MinecraftService.setPlayerLocRot',
    index=8,
    containing_service=None,
    input_type=_LOCROTMSG,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='setLocY',
    full_name='dk.itu.real.ooe.MinecraftService.setLocY',
    index=11,
    containing_service=None,
    input_type=_POINT,
    output_type=_POINT,
